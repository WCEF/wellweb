...
},{"./hash":8,"inherits":6,"safe-buffer":7}],11:[function(require,module,exports){
/*
...
},{"./hash":8,"inherits":6,"safe-buffer":7}],12:[function(require,module,exports){
/**
...
},{"./hash":8,"./sha256":13,"inherits":6,"safe-buffer":7}],13:[function(require,module,exports){
/**
 * A JavaScript implementation of the Secure Hash Algorithm, SHA-256, as defined
 * in FIPS 180-2
 * Version 2.2-beta Copyright Angel Marin, Paul Johnston 2000 - 2009.
...
},{"./hash":8,"inherits":6,"safe-buffer":7}],14:[function(require,module,exports){
var inherits = require('inherits')
...
},{"./hash":8,"./sha512":15,"inherits":6,"safe-buffer":7}],15:[function(require,module,exports){
var inherits = require('inherits')
var Hash = require('./hash')
var Buffer = require('safe-buffer').Buffer
...
},{"./hash":8,"inherits":6,"safe-buffer":7}],16:[function(require,module,exports){
(function(nacl) {
'use strict';
...
function verifyBlock(data, validators, networkId) {
  if (!(0, _helpers.isObject)(data)) {
    return false;
  } else if (!(0, _helpers.isObject)(data.block)) {
    return false;
...
},{"../crypto":21,"../helpers":22,"../types/generic":26,"../types/message":28,"../types/primitive":29,"../types/validate":31}],18:[function(require,module,exports){
'use strict';
...
function merklePatriciaProof(rootHash, proofNode, key, type) {
  ...
  function recursive(node, keyPrefix) {
    ...
    for (var keySuffix in node) {
      ...
      var branchValueHash = void 0;
      var nodeValue = node[keySuffix];
      var branchType = void 0;
      var branchKey = void 0;
      var branchKeyHash = void 0;
...
},{"../crypto":21,"../helpers":22,"../types/convert":25,"../types/generic":26,"../types/primitive":29,"../types/validate":31}],20:[function(require,module,exports){
'use strict';
...
},{"../crypto":21,"../helpers":22,"../types/convert":25,"../types/generic":26,"../types/validate":31,"big-integer":2}],21:[function(require,module,exports){
'use strict';
...
},{"../types/convert":25,"../types/generic":26,"../types/message":28,"../types/validate":31,"big-integer":2,"sha.js":9,"tweetnacl":16}],22:[function(require,module,exports){
'use strict';
...
},{"./blockchain":18,"./crypto":21,"./types":27}],24:[function(require,module,exports){
'use strict';
...
},{"./serialization":30}],25:[function(require,module,exports){
'use strict';
...
},{"../types/validate":31}],26:[function(require,module,exports){
'use strict';
...
},{"../crypto":21,"./serialization":30}],27:[function(require,module,exports){
'use strict';
...
},{"./array":24,"./convert":25,"./generic":26,"./message":28,"./primitive":29}],28:[function(require,module,exports){
'use strict';
...
},{"../crypto":21,"./generic":26,"./primitive":29,"./serialization":30}],29:[function(require,module,exports){
'use strict';
...
function serialize(buffer, shift, data, type, isTransactionBody) {
  ...
  function fieldIsFixed(field) {
    ...
    } else if (field.type === _primitive.String) {
      return false;
    }
    return true;
  }
  ...
  function serializeInstanceofOfNewType(buffer, shift, from, data, type) {
    if (fieldsAreFixed(type.fields)) {
      ...
      (0, _primitive.Uint32)(end - shift, buffer, from, from + 4); // start index
      buffer = serialize(buffer, end, data, type);
      (0, _primitive.Uint32)(buffer.length - end, buffer, from + 4, from + 8); // length
    }
  ...
  function serializeInstanceofOfNewArray(buffer, shift, from, data, type) {
    ...
    (0, _primitive.Uint32)(buffer.length, buffer, from, from + 4); // start index
    (0, _primitive.Uint32)(data.length, buffer, from + 4, from + 8); // array length
    ...
    if ((0, _generic.isInstanceofOfNewType)(type.type)) {
      ...
      for (var _i = 0; _i < data.length; _i++) {
        ...
        (0, _primitive.Uint32)(end - shift, buffer, index, index + 4); // start index
        buffer = serialize(buffer, end, data[_i], type.type);
        (0, _primitive.Uint32)(buffer.length - end, buffer, index + 4, index + 8); // length
      }
    } else if ((0, _array.isInstanceofOfNewArray)(type.type)) {
      var _start = buffer.length;

      // reserve segment for pointers
      for (var _i2 = _start; _i2 < _start + data.length * 8; _i2++) {
        buffer[_i2] = 0;
      }

      for (var _i3 = 0; _i3 < data.length; _i3++) {
        var _index = _start + _i3 * 8;

        buffer = serializeInstanceofOfNewArray(buffer, shift, _index, data[_i3], type.type);
      }
    } else if (type.type === _primitive.String) {
  ...
  for (var fieldName in type.fields) {
    ...
    var fieldShift = isTransactionBody === true ? 0 : shift;
    ...
    } else if ((0, _array.isInstanceofOfNewArray)(fieldType.type)) {
...
},{"./array":24,"./generic":26,"./primitive":29}],31:[function(require,module,exports){
'use strict';
